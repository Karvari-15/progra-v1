...
namespace WBL
{
    ...
    public class VehiculoService : IVehiculoService
    {
        ...
        public async Task<IEnumerable<VehiculoEntity>> Get()
        {
            try
            {
                var result = sql.QueryAsync<VehiculoEntity, MarcaVehiculoEntity>(sp: "VehiculoObtener", split: "VehiculoId,MarcaVehiculoId");
        ...
        public async Task<VehiculoEntity> GetById(VehiculoEntity entity)
        {
            try
            {
                var result = sql.QueryFirstAsync<VehiculoEntity>(sp: "VehiculoObtener", Param: new
                {
                    entity.VehiculoId
                }
                 );
        ...
        public async Task<DBEntity> Create(VehiculoEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync(sp: "VehiculoInsertar", Param: new
                {
        ...
        public async Task<DBEntity> Update(VehiculoEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync(sp: "VehiculoActualizar", Param: new
                {
                    entity.MarcaVehiculoId,
                    entity.Matricula,
                    entity.Color,
        ...
        public async Task<DBEntity> Delete(VehiculoEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync(sp: "VehiculoEliminar", Param: new
                {
                    entity.VehiculoId
                }
                 );
